...
<title>VIT BHOPAL UNIVERSITY|| HOME </title>
...
<?php
echo "<body style='background: url(image/comp5.jpg); background-repeat : repeat ;background-size: cover; background attachment: none;'>";
?>
...
<div><b><center>TEST YOUR SKILLS</center></b> </div>
...
<div class="col-md-3 panel"= style="background-image:url(image/back.jpg); min-height:500px;">
<!-- 
...
<!-- Text input-->
<div class="form-group">
<h3 align="center" style="font-family:'typo'; color:#63dd11"><u>FILL THE FORM FOR SIGN UP</u></h3>
