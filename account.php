...
<title>VIT BHOPAL UNIVERSITY||PLACEMENT AND TRAINING </title>
...
if($rowcount == 0){
	...
	<td><b><a href="account.php?q=quiz&step=2&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:#0b54c6"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></td></tr>';
}
else
{
...
<a href="image/ragz.jpg" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
