...
<title>VIT BHOPAL UNIVERSITY || FEEDBACK </title>
...
?>
  <?php
echo "<body style='background: url(image/feed.jpg); background-repeat : repeat ;background-size: cover; background attachment: none;'>";
?>
...
<div class="col-md-11 panel" style="background-image:url(image/bg2.jpg); min-height:430px;">
<h2 align="center" style="font-family:'typo'; color:#000016"><u>FEEDBACK/REPORT A PROBLEM</u></h2>
...
<div class="col-md-10">
<a href="mailto:raghavsankhdher@gmail.com" style="color:#1111111">raghavsankhdher@gmail.com</a><br /><br />
...
<a href="aboutuss.php" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
